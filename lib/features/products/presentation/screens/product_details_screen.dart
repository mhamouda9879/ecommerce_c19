...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    final product = ModalRoute.of(context)!.settings.arguments as DummyProduct;
    ...
    return Scaffold(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(formatPrice(product.price), style: _titleStyle),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${product.rating} (${formatNumber(product.ratingsCount)})',
                  maxLines: 1,
      ...
      bottomNavigationBar: TotalPriceBar(
